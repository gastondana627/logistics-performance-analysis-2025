...
Visual representation of the complete data pipeline:
- **Data Layer**: UPS Field Biometrics (7.55 SI threshold) + OSHA Injury Data (93k+ incidents)
- **Logic Layer**: Kinetic Logic Engine, V4-Hard Protocol, Canary Bench monitoring
- **Impact Layer**: ORCID/DOI academic validation + Vercel public dashboard
- Interactive node grid with color-coded layers
- Full Mermaid diagram available in `KNOWLEDGE_GRAPH.md`
...
│   ├── KnowledgeGraph.tsx      # System architecture visualization
│   ├── ExecutiveConnect.tsx    # Professional contact section
│   ├── ResearchTransparency.tsx # Academic footer with ORCID/DOI
│   └── WatchBot.tsx            # Galaxy Watch 5 digital twin AI assistant
├── data/
│   └── ups_health_clean.json   # Source of truth (generated by csv_to_json.py)
├── lib/
│   └── utils.ts                # Utility functions (cn helper)
├── KNOWLEDGE_GRAPH.md          # Full Mermaid diagram and architecture docs
